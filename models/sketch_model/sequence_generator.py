...
from models.data2text_transformer import EncoderOut
...
class SequenceGenerator(nn.Module):
    ...
    def _generate(
        ...
        encoder_outs = self.model.forward_encoder(
            field_tokens=encoder_input["field_tokens"],
            lpos_tokens=encoder_input["lpos_tokens"],
            rpos_tokens=encoder_input["rpos_tokens"],
...
class EnsembleModel(nn.Module):
    ...
    @torch.jit.export
    def forward_encoder(self, field_tokens, lpos_tokens, rpos_tokens, src_tokens, src_lengths):
        if not self.has_encoder():
            return None
        return [
            model.encoder(field_tokens=field_tokens, lpos_tokens=lpos_tokens, rpos_tokens=rpos_tokens,
