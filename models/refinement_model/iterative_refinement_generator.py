...
class IterativeRefinementGenerator(object):
    def __init__(
        ...
        self.no_delete_kwd = no_delete_kwd
        self.no_insert_kwd = no_insert_kwd
    ...
    def generate(self, models, sample, prefix_tokens=None, constraints=None):
        ...
        field_tokens = sample["net_input"]["field_tokens"]
        lpos_tokens = sample["net_input"]["lpos_tokens"]
        rpos_tokens = sample["net_input"]["rpos_tokens"]
        src_tokens = sample["net_input"]["src_tokens"]
        src_lengths = sample["net_input"]["src_lengths"]
        bsz, src_len = src_tokens.size()

        # initialize
        encoder_out = model.forward_encoder([field_tokens, lpos_tokens, rpos_tokens, src_tokens, src_lengths])
        prev_decoder_out = model.initialize_output_tokens(
            encoder_out, src_tokens, kwd_tokens=prefix_tokens
        )
        ...
        def finalized_hypos(step, kwd_tokens, prev_out_token, prev_out_score, prev_out_attn):
        ...
        for step in range(self.max_iter + 1):
            ...
            decoder_options = {
                ...
                "no_delete_kwd": self.no_delete_kwd,
                "no_insert_kwd": self.no_insert_kwd,
            ...
            finalized_kwd = decoder_out.kwd_tokens[terminated]
            ...
            prev_decoder_out = decoder_out._replace(
                kwd_tokens=decoder_out.kwd_tokens[not_terminated],
