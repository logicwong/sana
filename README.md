...
## preprocess
Preprocess the original data. The processed files contains field (attribute), value (attribute value), lpos (forward position of value in the attribute), rpos (reverse position of value in the attribute), tgt (description)
